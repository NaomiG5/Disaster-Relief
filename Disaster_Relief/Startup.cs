...
namespace Disaster_Relief
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<Disasters_Context>(options =>
            options.UseSqlServer(Configuration.GetConnectionString("online")));

            services.AddDbContext<MDonation_Context>(options =>
           options.UseSqlServer(Configuration.GetConnectionString("online")));

            services.AddDbContext<Goods_Context>(options =>
          options.UseSqlServer(Configuration.GetConnectionString("online")));
